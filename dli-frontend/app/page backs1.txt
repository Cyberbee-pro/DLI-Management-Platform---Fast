...
import Silk from "@/components/Silk"; // ⚡ NEW: Imported the Silk background!
    ...
    <div ref={containerRef} className="relative bg-black text-white selection:bg-lime-500/30 font-sans overflow-clip min-h-screen">
      ...
      <motion.div style={{ y: shutterY }} className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black text-center px-4 border-b border-lime-500/20 shadow-[0_15px_40px_rgba(0,0,0,0.9)] md:shadow-[0_30px_100px_rgba(0,0,0,0.9)] will-change-transform transform-gpu overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute bottom-12 flex flex-col items-center gap-2 opacity-50 will-change-transform transform-gpu z-10"
        >
          ...
          <h2 className="text-5xl md:text-7xl font-bold tracking-tighter leading-[0.9] flex flex-col gap-2 min-h-[160px] md:min-h-[220px]">
            {isHeadlineReady && (
              <>
                ...
                <BlurText text="next class of" delay={200} animateBy="words" direction="top" />
                <BlurText text="AI Engineers." delay={350} animateBy="words" direction="top" className="italic font-light" />
              </>
            )}
          </h2>
